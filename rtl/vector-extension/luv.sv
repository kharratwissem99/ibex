  ...
  always_comb begin
    ...
    unique case (ld_state_q)
      ...
      LSU_WAIT1: begin
        if (data_rvalid_i) begin
          if (data_err_i) ld_state_d = LSU_FAULT;
            ...
            ld_state_d   = need_two ? LSU_REQ2 : LSU_ALIGN;
          end
        end
      end
      ...
      LSU_WAIT2: begin
        if (data_rvalid_i) begin
          if (data_err_i) ld_state_d = LSU_FAULT;
            ...
            word_d = (data_rdata_i << (4-sh)) | word_q;
            ld_state_d   = LSU_ALIGN;
          end
        end
      end
      ...
      LSU_WRITE: begin
        ...
        //todo: implementiere error signal
        // advance or finish
        idx_e_d = idx_e_q + elems_beat;  // (3-bit -> zero-extends fine)
        ld_state_d = (idx_e_d >= vl_q) ? LSU_DONE : LSU_REQ1;
      end
